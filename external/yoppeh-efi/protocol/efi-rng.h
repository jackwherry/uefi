/**
 * @file efi-rng.h
 * @author Jack Wherry (jack@jackwherry.com)
 * @brief UEFI Random Number Generator Protocol.
 * @version 0.1.0
 * @date 2025-12-31
...
typedef EFI_STATUS (EFIAPI *EFI_RNG_GET_INFO)(IN struct EFI_RNG_PROTOCOL *This, IN OUT UINTN *RNGAlgorithmListSize, OUT EFI_RNG_ALGORITHM *RNGAlgorithmList);
typedef EFI_STATUS (EFIAPI *EFI_RNG_GET_RNG)(IN struct EFI_RNG_PROTOCOL *This, IN EFI_RNG_ALGORITHM *RNGAlgorithm, OPTIONAL IN UINTN RNGValueLength, OUT UINT8 *RNGValue);
